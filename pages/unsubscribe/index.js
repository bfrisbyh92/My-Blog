...
export default function Unsubscribe() {
    ...
    axios
      ...
      .then((result) => {
        ...
        if (result.status === 200) {
          setSuccess(true);
          localStorage.removeItem("is-subscribed");
        }
        console.log(result);
      })
      .catch((err) => {
  ...
  useEffect(() => {
    if (localStorage.getItem("is-subscribed"))
      setMail(localStorage.getItem("is-subscribed"));
  });
      ...
      <div className="max-w-screen-lg mx-auto relative z-10 h-[50vh] flex items-center">
        <div className="px-8 md:px-32">
          <div className="bg-black/50 p-6 rounded-[3rem] mt-8">
            <div className="text-white text-4xl">Sorry to see you go.</div>
            <div className="text-2xl opacity-50 text-white mt-2">
              You can unsubscribe from my newsletter anytime you want to stop
            ...
            {success && (
              <div className="text-green-400 text-2xl mt-2 flex items-center gap-2">
                You have succesfully unsubscribed from my mailing list!{" "}
